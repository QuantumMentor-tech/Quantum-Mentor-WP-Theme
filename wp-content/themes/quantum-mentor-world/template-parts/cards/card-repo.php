...
$post_id = get_the_ID();
$stars   = get_post_meta( $post_id, 'repo_stars_count', true );
$forks   = get_post_meta( $post_id, 'repo_forks_count', true );
...
$languages = wp_get_post_terms( $post_id, 'repo_category', array( 'fields' => 'names' ) );
